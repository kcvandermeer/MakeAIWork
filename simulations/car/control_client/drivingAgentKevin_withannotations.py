...
#import traceback as tb          #onbekend/niet gebruikt
#import math as mt               #onbekend/niet gebruikt
...
ss.path +=  [os.path.abspath (relPath) for relPath in  ('..',)]     #pad waar info uit systeem weggeschreven wordt
